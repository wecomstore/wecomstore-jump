...
class Index 
{
    ...
    public function index()
    {
        ...
        return $this->result(['username' => 'wecomstore', 'sex' => '男']);  
    }
}
~~~
...
class Index extends \app\BaseController
{
    ...
    public function demo3()
    {
        ...
        return $this->redirect(url('index/index', ['name' => 'wecomstore']));
        //return $this->redirect('http://www.wecomstore.cn');
        //完整用法
    ...
    public function demo4()
    {
        ...
        return $this->result(['username' => 'wecomstore', 'sex' => '男']);
        //完整用法
        //return $this->result($data=['username' => 'wecomstore', 'sex' => '男'], $code = 0, $msg = '', $type = '',  $header = []); 
    }
}
~~~